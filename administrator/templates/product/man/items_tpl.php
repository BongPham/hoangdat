  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    <thead>
      <tr>
        ...
        <!-- <td class="tb_data_small">SP bán chạy</td> -->
    ...
    <tbody>
       ...
       <!--  <td align="center">
        <a data-val2="table_<?=$_GET['com']?>" rel="<?=$items[$i]['thongdung']?>" data-val3="thongdung" class="diamondToggle <?=($items[$i]['thongdung']==1)?"diamondToggleOff":""?>" data-val0="<?=$items[$i]['id']?>" ></a> 
        </td> -->
       <?php if($config_noibat == "true"){ ?>
        <td align="center">
