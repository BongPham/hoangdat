...
function get_thuonghieu()
  {
  	global $item;
    $sql="select * from table_baiviet where  type='thuonghieu' order by stt asc";
    $stmt=mysql_query($sql);
    $str='
...
<form name="supplier" id="validate" class="form" action="index.php?com=product&act=save<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
	<div class="widget">
        ...
        <div class="formRow">
			<label>Chọn danh mục nổi bật</label>
			<div class="formRight">
			<?=get_main_item()?>
			</div>
			<div class="clear"></div>
    ...
    <?php }?>
		...
		<div class="formRow  ">
			...
			<div class="formRight">
                <input type="text" name="masp" title="Nhập sản phẩm" id="masp" class="tipS " value="<?=@$item['masp']?>" />
			</div>
			<div class="clear"></div>
		</div>
		...
		<div class="formRow  ">
			<label>Xuất xứ</label>
			<div class="formRight">
                <input type="text" name="xuatxu" title="Nhập xuất xứ" id="xuatxu" class="tipS " value="<?=@$item['xuatxu']?>" />
			</div>
			<div class="clear"></div>
		</div>
		...
		<div class="formRow  ">
			...
			<div class="formRight">
                <input type="text" name="baohanh_vi" title="Nhập bảo hành" id="baohanh_vi" class="tipS " value="<?=@$item['baohanh_vi']?>" />
			</div>
			<div class="clear"></div>
		</div>
		...
		<div class="formRow  ">
			...
			<div class="formRight">
                <input type="text" name="thongtin_vi" title="Nhập tình trạng" id="thongtin_vi" class="tipS " value="<?=@$item['thongtin_vi']?>" />
			</div>
			<div class="clear"></div>
		</div>
