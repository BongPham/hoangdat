...
<?php if($config_mota=='true'){ ?>
		<div class="formRow lang_hidden lang_vi active">
			<label>Mô tả</label>
			<?php if($_GET['type']=='huongdan'){ ?>
			<div class="ck_editor">
			<?php }else echo '<div class="formRight">'; ?>
                <textarea rows="4" cols="" name="mota_vi" id="mota_vi"><?=@$item['mota_vi']?></textarea>
			</div>
			<div class="clear"></div>
		</div>
		...
		<div class="formRow lang_hidden lang_en">
			...
			<div class="ck_editor">
			<?php }else echo '<div class="formRight">'; ?>
                <textarea rows="4" cols="" name="mota_en" id="mota_en"><?=@$item['mota_en']?></textarea>
			</div>
			<div class="clear"></div>
		</div>
<?php } ?>
<?php if($_GET['type']!='thuonghieu'){ ?>
		<div class="formRow lang_hidden lang_vi active">
