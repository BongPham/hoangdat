...
<div class="menu_hidden"><a href="#menu"><img src="images/menu.png" alt="Menu"></a></div>
<div id='cssmenu'>
    <ul>
        ...
        <li class="<?php if($_GET['com']=='chinh-sach'){?>active<?php }?> wow fadeInLeft " data-wow-delay='1.4s'><a href="kien-thuc-tieu-dung.html" title="Kiến thức tiêu dùng">Kiến thức tiêu dùng</a></li>
