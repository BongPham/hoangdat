...
.prev13{display:block!important; width: 15px; height: 40px; position: absolute; z-index: 10; background: url(images/prev1.png) no-repeat; top: 25px; left: 0px;}
.next13{ display:block!important;width: 15px; height: 40px; position: absolute; z-index: 10; background: url(images/next1.png) no-repeat; top: 25px; right: 0px;}
</style>
<?php
    $d->reset();
