                    ...
                    <li class="m_li">
                        ...
                        <ul class="list_categories">
                            ...
                            <li class="pc_menu">
                              ...
                              <ul>
                                <?php
                                  $sql_thuonghieu = "select DISTINCT  id_thuonghieu from #_product where id_list = '".$listsp_[$i]['id']."' and type='product' and id_thuonghieu != 0 and hienthi=1";
                                    $d->query($sql_thuonghieu);
