...
<div id="info">
        <div id="sanpham">
          <div class="thanh_index"><span>Giỏ hàng</span></div>
  ...
  <div style="margin-left: 2px; margin-right: 2px; color:#000;" class="giohang_tk">
    	...
    	<?php
			if(is_array($_SESSION['cart'])){
            	echo '<tr class="menu_giohang" ><td>Stt</td><td>Hình Ảnh</td><td>Tên Sản Phẩm</td><td>Dung tích</td><td>Giá</td><td>Số lượng</td><td>Tổng giá</td><td>Xóa</td></tr>';
				$max=count($_SESSION['cart']);
				for($i=0;$i<$max;$i++){
				...
				?>
            		...
            		<td width="29%"> <a href="san-pham/<?=changeTitle($pname)?>.html" style="color:rgba(0,102,153,1); font-size:16px; font-weight:bold;"><?=$pname?> </a>
